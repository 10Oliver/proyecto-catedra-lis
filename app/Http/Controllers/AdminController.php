...
class AdminController extends Controller
{
    public function index()
    {
        ...
        return view('admin.dashboard', compact('totalEmpresas', 'totalUsuarios', 'totalCupones', 'meses', 'ganancias'));
    }
    ...
    public function updateCompanyUser(Request $request, Company $company, User $user)
    {
        ...
        return redirect()->route('admin.empresas')->with('success', 'Usuario actualizado correctamente.');
    }
    ...
    public function destroyCompanyUser(Company $company, User $user)
    {
        ...
        return redirect()->route('admin.empresas')->with('success', 'Usuario eliminado correctamente. Ahora puede crear uno nuevo.');
    }
